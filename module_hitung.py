...
def hitung():
    ...
    return df_bobot, df_bobot_kualitas, df_matriks_keputusan_awal, df_normalisasi_bobot, df_element_matrik_tertimbang, df_nilai_matrik_batas, df_elemen_matriks_jarak_alternatif, df_perangkingan_alternatif